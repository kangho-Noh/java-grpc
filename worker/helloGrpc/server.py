...
import FieldMask_pb2  # message class
import FieldMask_pb2_grpc  # client & server class

# (3) 원격 호출될 함수들을 import 함
import  # original remotely called functions
...
hello_grpc_pb2_grpc.add_MyServiceServicer_to_server(
